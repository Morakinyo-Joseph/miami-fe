...
// import { Fingerprint, Camera as CameraIcon } from 'lucide-react';
// import { FingerType } from './types';
// import { uploadFingerprint } from './services/api';
...
//         client_id: 4, // This should be configurable in a real app
//         finger_type: selectedFinger,
//         finger_image: capturedImage
//       });

//       setMessage({ type: 'success', text: 'Fingerprint uploaded successfully!' });
...
//       // Fetch fingerprint details after successful upload
//       setTimeout(async () => {
//         try {
